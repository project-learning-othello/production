...
public class ClientSample3 extends JFrame implements MouseListener {
	...
	// コンストラクタ
	public ClientSample3(OthelloSample1 game) { //Othelloオブジェクトを引数とする
	...
	public static void main(String args[]){ 
		...
		ClientSample3 oclient = new ClientSample3(game); //引数としてオセロオブジェクトを渡す
